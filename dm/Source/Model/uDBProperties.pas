      ...
      fdbFirebird2, fdbFirebird3, fdbInterbase2017:
        begin
          ...
          begin
            ...
            Add('Smallint (Identity)', 'SMALLINT GENERATED BY DEFAULT AS IDENTITY (START WITH %e%)', false, false,
              naInteger, stSmallInt, true, true, true).ForeignDataTypeName := 'Smallint';
